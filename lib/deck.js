...
const SYMBOLS = [
  ...
  { emoji: '🍨', label: 'Amorino', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Amorino_Gelato_Flowers.jpg?width=300' },
  { emoji: '🍜', label: 'Wagamama Teriyaki', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Chicken_teriyaki.jpg?width=300' },
  { emoji: '🧀', label: 'Mac & Cheese', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Macaroni_and_cheese.jpg?width=300' },
  ...
  { emoji: '🟢', label: 'Green M&M', image: "https://commons.wikimedia.org/wiki/Special:FilePath/(Green)_M%26M%27s.JPG?width=300" },
  { emoji: '🤍', label: 'Burrata', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Burrata2.jpg?width=300' },
  { emoji: '🧈', label: 'Parmesan', image: '/images/parmesan.webp' },
  { emoji: '🍛', label: 'Butter Chicken (Dishoom)', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Murgh_Makhani_(Butter_Chicken)_2_(8925280003).jpg?width=300' },
  { emoji: '🍦', label: 'Ice Cream', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Ice_cream_cone_(cropped).jpg?width=300' },
  { emoji: '🥤', label: 'Diet Coke', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Generic_Cola_Cans_1980s.jpg?width=300' },
  { emoji: '☕', label: 'Hot Chocolate', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Chocolate_drink_in_mug.jpg?width=300' },
  { emoji: '🎊', label: 'Multicolour Sprinkles', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Strawberry_donut_with_sprinkles_(2).jpg?width=300' },
  ...
  { emoji: '🧋', label: 'Iced Coffee', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Iced_coffee_beverages.jpg?width=300' },
  { emoji: '🍰', label: 'Cookies & Cream Cake', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Strawberry_layer_cake.jpg?width=300' },
  ...
  { emoji: '🏛️', label: 'Colosseum', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Colosseum,_Rome_(15235081322).jpg?width=300' },
  ...
  { emoji: '🛶', label: 'Venice', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Gondola_on_the_Grand_Canal,_Venice,_Italy.jpg?width=300' },
  ...
  { emoji: '🐦', label: 'Mockingjay', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Mimus_polyglottos1.jpg?width=300' },
  ...
  { emoji: '🎭', label: 'Hamilton', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Broadway_Theatre_NYC_entrance.jpg?width=300' },
  ...
  { emoji: '💃', label: 'Dancer', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Victoria_Aletta_Ballet_Dancer.jpg?width=300' },
  { emoji: '🩰', label: 'Dance Shoes', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Russian_ballet_pointe_shoes,_1997,_silk_-_Bata_Shoe_Museum_-_DSC00244.JPG?width=300' },
  ...
  { emoji: '🐓', label: 'Spurs', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Beautifull_big_cockerel_(5752263978).jpg?width=300' },
  ...
  { emoji: '🧪', label: 'Science Kit', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Graduated_Cylinders_and_Beaker_filled_with_Chemical_Compounds.jpg?width=300' },
];
