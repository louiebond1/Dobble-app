...
const SYMBOLS = [
  ...
  { emoji: '🥯', label: 'Bagels', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Bagel_with_sesame_3.jpg?width=800' },
  ...
  { emoji: '🧈', label: 'Parmesan', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Parmigiano_reggiano_piece.jpg?width=800' },
  ...
  { emoji: '🧙‍♀️', label: 'Elphaba', image: 'https://commons.wikimedia.org/wiki/Special:FilePath/Halloween_witch_smiling.jpg?width=800' },
  ...
  { emoji: '🐶', label: 'Beige Cavapoo', image: '/images/beige-cavapoo.jpg' },
