...
const SYMBOLS = [
  ...
  { emoji: '☕', label: 'Hot Chocolate', image: null },
  { emoji: '🎊', label: 'Multicolour Sprinkles', image: '/images/sprinkles.jpg' },
  { emoji: '🥑', label: 'Avocado Toast', image: null },
  ...
  { emoji: '🍭', label: 'Orange Calippo', image: null },
  { emoji: '🍗', label: "Chicken Tenders (McDonald's)", image: null },
  ...
  { emoji: '❄️', label: 'Elsa', image: null },
  { emoji: '🎭', label: 'Hamilton', image: '/images/hamilton.jpg' },
  { emoji: '🕶️', label: 'Men In Black', image: null },
  ...
  { emoji: '🧸', label: 'Ballerina Teddy Bear', image: null },
