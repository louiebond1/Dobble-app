...
const SYMBOLS = [
  ...
  { emoji: '🚇', label: 'London Underground', image: '/images/london-underground.png' },
  ...
  { emoji: '🐩', label: 'Beige Labradoodle', image: '/images/beige-labradoodle.png' },
  { emoji: '🐹', label: 'Lemming', image: '/images/lemming.png' },
  ...
  { emoji: '🐰', label: 'Bunny Teddy Bear', image: '/images/bunny-teddy-bear.png' },
  { emoji: '🏷️', label: 'Jellycat Logo', image: '/images/jellycat-logo.png' },
