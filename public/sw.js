...
// Sprint, Category Blitz, Emoji Decode, Tic-Tac-Toe Showdown (vs CPU), and
// Sliding Puzzle Race. Two-person-only modes (Quick Play, What Would You
// Say, Date Roulette, Doodle Duel, Compatibility Quiz, and the
// Head-to-Head side of the other duel games) sync two separate phones
// through the live server by design and aren't included — there's no
// meaningful "offline" version of a game two people play together in
